var fog = {
    ...
    initLevel:function(){
        try {
            // Check if game.currentLevel exists and has required properties
            if (!game.currentLevel) {
                console.error("game.currentLevel is not defined");
                return;
            }
            
            if (!game.currentLevel.mapGridWidth || !game.currentLevel.mapGridHeight) {
                console.error("game.currentLevel missing mapGridWidth or mapGridHeight");
                return;
            }
            ...
            if (!this.context) {
                console.error("Failed to get 2D context for fog canvas");
                return;
            }
            ...
            console.error("Error in fog.initLevel():", error);
            throw error;
        }
    },
    ...
    animate:function(){
        try {
            ...
            if (!this.context || !game.currentMapImage) {
                console.warn("Fog animate: Missing context or map image");
                return;
            }
            ...
            console.error("Error in fog.animate():", error);
        }
    },
    draw:function(){
