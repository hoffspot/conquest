...
//   muzzle      where shots leave the gun, in world pixels: [ahead of the item's centre, height
//               above the ground] (for muzzle flashes; otherwise shots start where the game puts
//               the bullet)
//   recoil      how the item rocks when it fires: the hull moves `back` pixels and tips `pitch`
//               degrees nose-up, then rocks forward and settles; the `gun` part slides `kick`
//               pixels back
//
...
export const MODELS = {
    "vehicles/heavy-tank": {
        ...
        footprint: 28,
        facing: "-x",
        recolour: ["Main", "Main_Light", "Main_Dark"],
        muzzle: [14, 6.4],
        recoil: { back: 2.5, pitch: 7, gun: "Tank_Gun", kick: 2.5 },
    },
    "vehicles/scout-tank": {
        file: "scout-tank.glb",
        footprint: 22,
        ...
        recolour: ["Main", "Main_Light", "Main_Dark"],
        muzzle: [11, 4.9],
        recoil: { back: 1.5, pitch: 5, gun: "Tank_Gun", kick: 1.5 },
    },
    ...
    "buildings/ground-turret": {
        file: "ground-turret.glb",
        footprint: [20, 18],
        facing: "+z",
        recolour: ["Orange"],
        aim: "Turret_Gun_Top",
        muzzle: [9, 5.8],
        recoil: { gun: "Turret_Gun_Top", kick: 2 },
    },
};
